...
p = '/Users/xianghe/Downloads/AF-classification-master'
...
df = pd.read_csv('/Users/xianghe/Downloads/AF-classification-master/train2017_df_af_10s.csv')
data = df.values
data.shape
# save data
# open a binary file in write mode
file = open('/Users/xianghe/Downloads/AF-classification-master', "wb")
# save array to the file
np.save(file, data)
# close the file
file.close
